#!/usr/bin/env python3
"""
Final working sync that handles foreign key constraints
"""
...
def main():
    ...
    print("🔄 Final Working Staging Sync")
    print("=" * 40)
    ...
    try:
        ...
        with prod_engine.connect() as prod_conn, staging_engine.connect() as staging_conn:
            ...
            # Sync clergy in batches, handling foreign key constraints
            ...
            # First, insert clergy without foreign key references
            for cl in clergy:
                staging_conn.execute(text("""
