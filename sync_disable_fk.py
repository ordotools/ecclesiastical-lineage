#!/usr/bin/env python3
"""
Sync with foreign key constraints disabled
"""
...
def main():
    ...
    print("🔄 Staging Sync (FK Disabled)")
    print("=" * 40)
    ...
    try:
        ...
        with prod_engine.connect() as prod_conn, staging_engine.connect() as staging_conn:
            ...
            staging_conn.execute(text("SET session_replication_role = replica;"))
            ...
            staging_conn.execute(text("SET session_replication_role = DEFAULT;"))
            staging_conn.commit()
