#!/usr/bin/env python3
"""
Simple sync that works with actual production schema
"""
...
def main():
    ...
    print("🔄 Simple Staging Sync (Production Schema)")
    print("=" * 50)
    ...
    try:
        ...
        with prod_engine.connect() as prod_conn, staging_engine.connect() as staging_conn:
            ...
            # Sync organizations (production schema)
